...
ui=shinyUI(bootstrapPage(theme = shinytheme("sandstone"),
                           ...
                           conditionalPanel(condition = "input.tabselected == 1",
                                            ...
                                            fileInput("in_table", "Please select your table.\n
                                                   Note: this should be saved either as *.txt or *.tsv",
                                                      accept = c(".txt", ".tsv")),
                                            h3("Click below to check your input data"),
					    ...
					    tags$style("#pietype {color:red;font-weight: bold}"),
                                            fluidRow(
					    ...
					    tags$style("#alltype {color:red;font-weight: bold}"),
                        ...
                        "))
                           ...
                           tabsetPanel(
                             ...
                             tabPanel("Data", value = 1,
                                      h4("Please check you input file"),
                                      #h4("Input Data file"),
